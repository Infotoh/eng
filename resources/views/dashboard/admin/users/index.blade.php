                ...
                <div class="row mb-2">
                    ...
                    <div class="col-md-12">
                        ...
                        {{-- @if (auth()->user()->hasPermission('read_users'))
                            <a href="{{ route('dashboard.admin.users.create') }}" class="btn btn-primary"><i class="fa fa-plus"></i> @lang('site.create')</a>
                        @endif --}}

                        @if (auth()->user()->hasPermission('delete_users'))
                            <form method="post" action="{{ route('dashboard.admin.users.bulk_delete') }}" style="display: inline-block;">
                                @csrf
                                @method('delete')

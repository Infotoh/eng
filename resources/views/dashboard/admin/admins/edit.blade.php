...
@section('content')
    ...
    <ul class="breadcrumb mt-2">
        <li class="breadcrumb-item"><a class="back-page" href="{{ route('dashboard.admin.welcome') }}">@lang('site.home')</a></li>
    ...
    <div class="row">
        ...
        <div class="col-md-12">
            ...
            <div class="tile shadow">
                ...
                <form method="post" action="{{ route('dashboard.admin.admins.update', $admin->id) }}">
                    @csrf
                    @method('put')
